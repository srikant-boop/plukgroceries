...
export const stapleProducts: PantryProduct[] = [
  ...
  staple({
    ...
    name: "Besan",
    shortDescription: "Gram flour — 20 lb.",
    unit: "20 lb",
    cost: 5.5,
    rule: "margin",
    pricingRole: "margin",
  ...
  staple({
    ...
    name: "Rava / Sooji",
    shortDescription: "Semolina — 20 kg.",
    unit: "20 kg",
    cost: 4.5,
    rule: "margin",
    pricingRole: "margin",
  ...
  staple({
    ...
    shortDescription: "Ground turmeric — 400 g.",
    unit: "400 g",
    cost: 2.5,
    rule: "margin-strong",
    pricingRole: "margin",
  ...
  staple({
    ...
    shortDescription: "Ground red chilli — 400 g.",
    unit: "400 g",
    cost: 2.5,
    rule: "margin-strong",
    pricingRole: "margin",
  ...
  staple({
    ...
    name: "Cumin Powder",
    shortDescription: "Ground cumin — 400 g.",
    unit: "400 g",
    cost: 2.5,
    rule: "margin-strong",
    pricingRole: "margin",
  ...
  staple({
    ...
    shortDescription: "Ground coriander — 400 g.",
    unit: "400 g",
    cost: 2.5,
    rule: "margin-strong",
    pricingRole: "margin",
  ...
  staple({
    ...
    name: "Maggi Noodles",
    shortDescription: "Maggi 2-Minute Masala noodles — 70 g pack.",
    brand: "Maggi",
    unit: "70 g",
    cost: 4.0,
    rule: "margin",
  ...
  staple({
    ...
    name: "Lays Chips",
    shortDescription: "Lays Magic Masala chips — ~52 g.",
    brand: "Lays",
    unit: "~52 g",
