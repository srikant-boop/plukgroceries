...
export const stapleProducts: PantryProduct[] = [
  ...
  staple({
    ...
    shortDescription: "National mixed vegetable achar — 1 kg jar.",
    brand: "National",
    unit: "1 kg",
    cost: A1_UNIT_COSTS.nationalPickle1kg,
    collection: "cooking",
    category: "Cooking essentials",
    roleLine: "Everyday mixed achar for rice and roti.",
    whySelected: "National 1 kg on A1 @ $5.49 — better home size than 2.27 kg jar.",
  }),
  staple({
    id: "makhana",
